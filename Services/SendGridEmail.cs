...
namespace Learn_Identity_App.Services
{
    public class SendGridEmail:ISendGridEmail
    {
        ...
        public SendGridEmail(IOptions<AuthMessageSenderOptions> options, ILogger<SendGridEmail> logger) //This section is what gets the ApiKey
        { 
        ...
        private async Task Execute(string apiKey, string subject, string message, string toEmail)
        {
            ...
            {
                From = new EmailAddress("rishongatcke@gmail.com"),
                Subject = subject,
